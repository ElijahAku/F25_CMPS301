...
int main()
{
    ...
    tree["start"] = { "Do you want a hot or iced drink today? or try our new ꜱᴇᴄʀᴇᴛ ᴍᴇɴᴜ ? (hot/iced/sm): ", { {"hot","Hot"}, {"Hot","Hot"}, {"iced","Iced"}, {"Iced","Iced"}, {"sm","SM"}, {"SM","SM"}}};
   
    tree["SM"] = { "ᴀ ᴄᴏʟᴅ ꜱʜɪᴠᴇʀ ᴄʀᴀᴡʟꜱ ᴅᴏᴡɴ ʏᴏᴜʀ ʙᴀᴄᴋ…, 'ɪ ɢᴜᴇꜱꜱ ʏᴏᴜ'ʀᴇ ɴᴇᴡ ᴛᴏ ᴏᴜʀ ꜱᴇᴄʀᴇᴄᴛ ᴍᴇɴᴜ ....ɪꜱ ᴛʜᴀᴛ ʀɪɢʜᴛ?' ᴛʜᴇ ʟɪɢʜᴛꜱ ꜰʟɪᴄᴋᴇʀ ᴏɴᴄᴇ. ᴛʜᴇ ʀᴏᴏᴍ ɢᴏᴇꜱ ꜱᴛɪʟʟ. ᴀ ʜɪᴅᴅᴇɴ ᴘᴀɴᴇʟ ᴄʀᴇᴀᴋꜱ ᴏᴘᴇɴ ʙᴇʜɪɴᴅ ʏᴏᴜ. ᴡᴇʟʟ… ɴᴏᴡ ʏᴏᴜ’ʀᴇ ꜱᴛᴜᴄᴋ. ᴏɴʟʏ ᴛᴡᴏ ᴅᴏᴏʀꜱ ᴏᴘᴇɴ ꜰᴏʀ ʏᴏᴜ ɴᴏᴡ ᴄʜᴏᴏꜱᴇ ᴄᴀʀᴇꜰᴜʟʟʏ ꜱᴀɪᴅ ᴛʜᴇ ʙᴀʀɪꜱᴛᴀ. (basement/attic): ", {{"basement","Basement"}, {"Basement","Basement"}, {"attic","Attic"}, {"Attic","Attic"}}};
        tree["Basement"] = { "ᴀꜱ ʏᴏᴜ ᴇɴᴛᴇʀ, ᴛʜᴇ ᴀɪʀ ɢʀᴏᴡꜱ ᴅᴀᴍᴘ. ꜱᴏᴍᴇᴛʜɪɴɢ ᴅʀɪᴘꜱ ɪɴ ᴛʜᴇ ᴅᴀʀᴋɴᴇꜱꜱ ʙᴇʟᴏᴡ. ᴀ ʟᴏᴡ ʜᴜᴍ ᴀʟᴍᴏꜱᴛ ʟɪᴋᴇ ᴄʜᴀɴᴛɪɴɢ ʀɪꜱᴇꜱ ꜰʀᴏᴍ ᴜɴᴅᴇʀɴᴇᴀᴛʜ ᴛʜᴇ ꜰʟᴏᴏʀʙᴏᴀʀᴅꜱ. ᴅᴏ ʏᴏᴜ ᴄʜᴏᴏꜱᴇ ᴛᴏ ᴇxᴘʟᴏʀᴇ ꜰᴜʀᴛʜᴇʀ. (Y): ", {{"y","Basement_result"}, {"Y","Basement_result"}}};
        tree["Attic"] = { "ᴅᴜꜱᴛ ᴅʀɪꜰᴛꜱ ᴅᴏᴡɴ ꜰʀᴏᴍ ᴛʜᴇ ꜱᴛᴀɪʀꜱ…ᴛʜᴇɴ, ꜰʀᴏᴍ ᴛʜᴇ ꜰᴀʀ ᴄᴏʀɴᴇʀ, ꜱᴏᴍᴇᴛʜɪɴɢ ꜱᴄʀᴀᴛᴄʜᴇꜱ — ꜱʟᴏᴡ, ᴅᴇʟɪʙᴇʀᴀᴛᴇ. ᴀ ꜱᴏᴜɴᴅ ᴛʜᴀᴛ ꜱʜᴏᴜʟᴅɴ’ᴛ ʙᴇ ᴛʜᴇʀᴇ. ʏᴏᴜʀ ʙʀᴇᴀᴛʜ ᴄᴀᴛᴄʜᴇꜱ ᴀꜱ ʏᴏᴜ ꜰᴇᴇʟ ɪᴛ ᴡᴀᴛᴄʜɪɴɢ. ʏᴏᴜ ꜱᴛᴇᴘ ᴛᴏᴡᴀʀᴅ ᴛʜᴇ ᴄᴏʀɴᴇʀ… ᴇᴠᴇɴ ᴛʜᴏᴜɢʜ ᴇᴠᴇʀʏ ɪɴꜱᴛɪɴᴄᴛ ʙᴇɢꜱ ʏᴏᴜ ɴᴏᴛ ᴛᴏ. ᴄʜᴇᴄᴋ ɪᴛ ᴏᴜᴛ ? (Y): ", {{"y","Attic_result"}, {"Y","Attic_result"}}};
    ...
    tree["Iced"] = { "Imagine this, its a sunny morning. The sun is shining, the birds are chirping and you can tell its going to get warm.\nWhat are your plans for the day? Are you packing your things in the car to go to the BEACH\nor are you getting a bag of snacks together to go to the PARK? (beach/park): ", { {"beach","Beach_day"}, {"Beach","Beach_day"}, {"park","Park_day"}, {"Park","Park_day"}}};
        ...
        // Define results
            ...
            tree["Attic_result"] = { "", {}, true, "Congrats! You have discovered the iconic Roblox-themed Bloxy Cola!" };
            tree["Basement_result"] = { "", {}, true, "Congrats! You have discovered the iconic Simpsons-themed Duff Beer!" };
